...
const HeroSection = () => {
  return (
    <section className="relative pt-1 md:pt-[84px] pb-1">
      <div className="container mx-auto max-w-7xl">
        <div className="relative rounded-[2rem] overflow-hidden bg-gradient-to-r from-[#fdf2f8] via-[#f5f3ff] to-[#f0f9ff] dark:from-slate-900 dark:to-slate-800 p-8 md:p-12 text-slate-900 dark:text-white shadow-xl border border-white/20">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-6">
              ...
              <div className="flex flex-col gap-4">
                <h1 className="text-3xl md:text-5xl lg:text-6xl font-black tracking-tighter mb-2 leading-[1.1]">
                  Everything stationery,<br className="hidden md:block" /> at <span className="text-[#ff0000]">Blink-speed.</span>
                </h1>
            ...
            {/* Category Rotator - Simple Infinite Strip */}
            <div className="hidden lg:flex items-center justify-center relative overflow-hidden h-10 w-64">
              <div className="flex flex-col items-center animate-vertical-roll">
                {[
                  "Writing", "Notebooks", "Art Supplies", "Office Desk",
                  "School Gear", "Combos", "Papers", "Gift Sets",
                  "Writing" // Duplicate first item for seamless loop
                ].map((category, i) => (
                  <span key={i} className="h-10 flex items-center text-[#ff0000] font-black text-2xl uppercase tracking-[0.1em] whitespace-nowrap">
                    {category}
                  </span>
                ))}
              </div>
