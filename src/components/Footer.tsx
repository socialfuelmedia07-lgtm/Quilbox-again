      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <a href="/" className="flex items-center gap-2 w-fit bg-white px-3 py-1.5 rounded-full hover:bg-slate-100 transition-colors shadow-md border border-slate-200">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["About Us", "Careers", "Partners Store", "Contact"].map((link) => (
                <li key={link}>
                  <a
                    href={link === "Partners Store" ? "/partners" : "#"}
                    className="text-background/70 hover:text-primary transition-colors text-sm"
                  >
                    {link}
                  </a>
